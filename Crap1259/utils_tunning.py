...
def cnn_model(hp,num_genotype_features,doubleT,Th,softm,linear):
...
def fc_model(hp,rel_features,doubleT,Th,softm,linear):
    ...
    dense_sp = hp.Int('dense_units_sp', min_value=32, max_value=128, step=32)
...
def mul_model(hp,num_genotype_features,rel_features,doubleT,Th,softm,linear):
