...
zt = pac_mean_sd[combine == "original",]
zt$value = zt[,..pv]
zt$valuese = zt[,..pvse]
zt$type = factor(zt$type,level = c("ST","MT_continuous","MT_binary"))
zt$MODE = factor(zt$MODE,level = c("PBLUP","GBLUP","FCN","CNN","MNN"))
...
ggsave("Figrue_pac_pure.pdf", P , width = 15, height = 6, dpi = 300)
ggsave("Figrue_pac_low.pdf", P , width = 15, height = 6, dpi = 300)
ggsave("Figrue_pac_medium.pdf", P , width = 15, height = 6, dpi = 300)
ggsave("Figrue_pac_high.pdf", P , width = 15, height = 6, dpi = 300)
...
zt$valuese = zt[,..pvse]
zt$type = factor(zt$type,level = c("ST","MT_continuous","MT_binary"))
zt$MODE = factor(zt$MODE,level = c("GBLUP","FCN","CNN","MNN"))
